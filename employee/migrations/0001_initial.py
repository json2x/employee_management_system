# Generated by Django 3.2.9 on 2021-12-11 11:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landline_number', models.CharField(blank=True, max_length=25, null=True)),
                ('present_address', models.CharField(max_length=250)),
                ('provincial_address', models.CharField(blank=True, max_length=250, null=True)),
                ...
                ('emergency_contact_relationship', models.CharField(choices=[('Mother', 'Mother'), ('Father', 'Father'), ('Sibling', 'Sibling'), ('Wife', 'Wife'), ('Child', 'Child'), ('Relative', 'Relative'), ('Others', 'Others')], max_length=10)),
            ],
            options={
