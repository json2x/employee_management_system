...
from employee.models import PersonalData as Employee, Family, ContactInformation, \
    DisciplinaryAction, WorkProfile
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    def age(self, obj):
        return obj.age()
    list_display = ('revrse_full_name', 'middle_name', 'birth_date', 'age', 'gender')
...
class FamilyAdmin(admin.ModelAdmin):
    ...
    def employee_name(self, obj):
        return obj.employee.revrse_full_name()
    
    @admin.display(description='Age')
    def age(self, obj):
        return obj.age()
    list_display = ('revrse_full_name', 'age', 'relationship', 'employee_name')
